...
export function main(): void {
	...
	const level =
		typeof args.values.level === "string"
			? args.values.level.toUpperCase()
			: undefined;
	const grep =
		typeof args.values.grep === "string" ? args.values.grep : undefined;
	const linesVal = parseInt(
		typeof args.values.lines === "string" ? args.values.lines : "20",
		10,
	);
