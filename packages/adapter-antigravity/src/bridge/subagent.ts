...
function parseSummariesPb(): Record<string, { parentConversationId?: string; typeName?: string }> {
  ...
  const result: Record<string, { parentConversationId?: string; typeName?: string }> = {};
